                    ...
                    <div class="p-4">
                        <div class="flex flex-col gap-y-4">
                            <div class="flex flex-col gap-y-2">
                                ...
                                <input type="number" name="code" id="code" placeholder="23874632" value="{{ old('code') }}" required
                            ...
                            <div class="flex flex-col gap-y-2">
                                ...
                                <input type="text" name="name" id="name" placeholder="Komputasi Grid" value="{{ old('name') }}" required
                                       class="placeholder:text-sm md:placeholder:text-base border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                @error('name')
                                <span class="text-red-500 text-xs md:text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="flex flex-col gap-y-2">
                                ...
                                <input type="number" min="1" max="4" name="credit" id="credit" placeholder="4" value="{{ old('credit') }}" required
                                       class="placeholder:text-sm md:placeholder:text-base border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                <span>
