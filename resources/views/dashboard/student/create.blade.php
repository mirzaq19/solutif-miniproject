...
@section('content')
    <div class="container min-h-screen lg:h-min mx-auto px-4 py-10">
        ...
        @endif
        <h1 class="font-bold text-2xl">Tambah Mahasiswa</h1>
                    ...
                    <div class="p-4">
                        <div class="flex flex-col gap-y-4">
                            <div class="flex flex-col gap-y-2">
                                ...
                                <input type="text" name="name" id="name" placeholder="Budi" value="{{ old('name') }}"
                    ...
                    <div class="p-4">
                        <div class="flex flex-col gap-y-4">
                            <div class="flex flex-col gap-y-2">
                                ...
                                <input type="number" name="nim" id="nim" placeholder="1234" value="{{ old('nim') }}"
                                       class="placeholder:text-sm md:placeholder:text-base border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                @error('nim')
                                    <span class="text-red-500 text-xs md:text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="flex flex-col gap-y-4">
                                <div class="flex flex-col gap-y-2">
                                    ...
                                    <textarea type="number" name="address" id="address" placeholder="alamat" rows="2"
                                              class="placeholder:text-sm md:placeholder:text-base border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{old('address')}}</textarea>
                                </div>
                                @error('address')
                                    <span class="text-red-500 text-xs md:text-sm">{{ $message }}</span>
                                @enderror
