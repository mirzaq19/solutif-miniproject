...
@section('content')
    <div class="container min-h-screen lg:h-min mx-auto px-4 py-10">
        ...
        <div class="my-4 flex flex-col text-center md:flex-row md:justify-end">
            <a href="#" class="w-full md:w-1/6 lg:w-1/12 focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 rounded-lg text-sm px-3 py-2 mr-2 mb-2"><i class="fas fa-edit"></i> Edit</a>
